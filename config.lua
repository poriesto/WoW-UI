...
ChatFrame1EditBox:SetPoint("TOPLEFT",GeneralDockManager,"TOPLEFT");ChatFrame1EditBox:EnableMouse(false);ChatFrame1:EnableMouse(false)
ChatFrame1Tab:ClearAllPoints();ChatFrame1Tab:SetPoint("CENTER", UIParent, "CENTER", -990, -990);ChatFrame1Tab.SetPoint = function() end
